...
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$calender$2f$calender$2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Downloads/calender/calender/node_modules/bcryptjs/index.js [app-client] (ecmascript)");
...
const Auth = ()=>{
    ...
    const handleSignup = async ()=>{
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$calender$2f$calender$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createUserWithEmailAndPassword"])(Auth, pseudoEmail, password);
            // Hash password before saving
            const hashedPassword = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$calender$2f$calender$2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].hash(password, 10);
            // Store user profile
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$calender$2f$calender$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$calender$2f$calender$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(db, "users", username), {
                username,
    ...
    const handleLogin = async ()=>{
        ...
        try {
            ...
            const userDoc = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$calender$2f$calender$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$calender$2f$calender$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(db, "users", username));
            if (!userDoc.exists()) {
                throw new Error("User not found");
            }
            const userData = userDoc.data();
            // Verify hashed password
            const isValid = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$calender$2f$calender$2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].compare(password, userData.passwordHash);
            if (!isValid) throw new Error("Invalid credentials");
            // Login with pseudo-email
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$calender$2f$calender$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signInWithEmailAndPassword"])(auth, pseudoEmail, password);
            toast({
                title: "Welcome Back!",
...
const CalendarHeader = (t0)=>{
    ...
    if ($[0] !== "964233cdc94b98abb0673391324832d8ae0fc4180e477abaa769b4242b3f8c7c") {
        for(let $i = 0; $i < 29; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "964233cdc94b98abb0673391324832d8ae0fc4180e477abaa769b4242b3f8c7c";
    }
...
const CalendarCell = (t0)=>{
    ...
    if ($[0] !== "0a4a6c7f171278962ca168477e7575ab3fcb49a8e529ce5e6eeb2cbf310f93a7") {
        for(let $i = 0; $i < 26; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "0a4a6c7f171278962ca168477e7575ab3fcb49a8e529ce5e6eeb2cbf310f93a7";
    }
...
const Page = ()=>{
    ...
    if ($[0] !== "837f52d18824af241e86d426e70739a06bc6cb2c26fb2326027677f204d5d15d") {
        for(let $i = 0; $i < 6; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "837f52d18824af241e86d426e70739a06bc6cb2c26fb2326027677f204d5d15d";
    }
    const [session, setSession] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$calender$2f$calender$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
...
_s(Page, "5nrHfIcEuKfTkDSHs9VbuHSW6Xk=");
_c = Page;
...
//# sourceMappingURL=Downloads_calender_calender_src_app_c3418f34._.js.map